    ...
    <div class="content">
      <div class="conversation">
        <ul class="conversation__inner">
          <li v-for="(list, key) in messageList" :key="key">
            <div class="conversation__user__image"><img :src="list.profilePicUrl" alt=""></div>
            <div class="conversation__user__columns">
              <p class="conversation__user__name">{{list.name}}</p>
              <p class="conversation__user__text">{{list.text}}</p>
            </div>
          </li>
        </ul>
      </div>
